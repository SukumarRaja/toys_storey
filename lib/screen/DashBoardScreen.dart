    ...
    return Observer(
      builder: (context) => Scaffold(
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          unselectedItemColor: isHalloween
          ...
          items: [
            BottomNavigationBarItem(
                ...
                activeIcon: Icon(Ionicons.ios_home,
                    color: isHalloween ? white : primaryColor),
                label: appLocalization.translate("lbl_home")),
            BottomNavigationBarItem(
                icon: Icon(Ionicons.ios_grid_outline,
                    color: isHalloween
                        ? white.withOpacity(0.6)
                        : Theme.of(context).textTheme.titleMedium!.color),
                activeIcon: Icon(Ionicons.ios_grid,
                    color: isHalloween ? white : primaryColor),
            ...
            BottomNavigationBarItem(
              ...
              activeIcon: Stack(
                children: <Widget>[
                  Icon(MaterialIcons.shopping_bag,
                      color: isHalloween ? white : primaryColor),
            ...
            BottomNavigationBarItem(
              icon: Icon(Icons.favorite_outline_sharp,
                  color: isHalloween
                      ? white.withOpacity(0.6)
                      : Theme.of(context).textTheme.titleMedium!.color),
              activeIcon: Icon(MaterialIcons.favorite,
                  color: isHalloween ? white : primaryColor),
